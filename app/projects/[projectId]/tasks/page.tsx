    ...
    return (
        ...
        <div className="p-4 max-w-6xl mx-auto scale-[0.95] origin-top">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
                <h1 className="text-4xl font-bold mb-4 text-center text-white">Задачі</h1>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="h-12 w-12 rounded-2xl text-2xl font-bold text-white bg-linear-to-br bg-gray-700 shadow hover:scale-105 active:scale-95 transition"
                    >
                        +
                    </button>
                </div>
            ...
            <div className="grid gap-6">
                {tickets.map((ticket, i) => (
                    <motion.div
                        ...
                        onClick={() =>
                            (window.location.href = `/projects/${projectId}/tasks/${ticket.id}`)
                        }
