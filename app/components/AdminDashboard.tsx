...
const mockOperations: Operation[] = [
    { id: 1, category: "Продажи", type: "Доход", amount: 5000, date: "2025-10-31" },
    { id: 2, category: "Закупки", type: "Расход", amount: 2000, date: "2025-10-30" },
    { id: 3, category: "Услуги", type: "Доход", amount: 1500, date: "2025-10-28" },
    { id: 4, category: "Аренда", type: "Расход", amount: 1000, date: "2025-10-29" },
];
        ...
        <div className="p-6 max-w-7xl mx-auto">
            ...
            {activeTab === "table" && (
                <div className="flex justify-center p-4">
                    <table className="min-w-[900px] bg-white border border-gray-300 shadow-md">
                        ...
                        {mockOperations.map((op) => (
                            <tr key={op.id} className="text-center">
                                <td className="py-2 px-4 border-b">{op.category}</td>
